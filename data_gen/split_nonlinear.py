"""Split realisations_nonlinear 70/15/15 → data/splits_nonlinear/

Mirrors split_diurnal.py; additionally carries the nl_meta array through so the
nonlinearity settings stay recoverable in each split.
"""
...
REAL_DIR  = os.path.join("data", "realisations_nonlinear")
SPLIT_DIR = os.path.join("data", "splits_nonlinear")
