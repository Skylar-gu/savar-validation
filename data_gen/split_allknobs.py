"""Split realisations_allknobs 70/15/15 → data/splits_allknobs/

Mirrors split_nonlinear.py; additionally carries centres, ng_meta and
move_meta through so the all-knobs settings stay recoverable in each split.
"""
...
REAL_DIR  = os.path.join("data", "realisations_allknobs")
...
PASSTHROUGH = ("ground_truth_graph", "W", "W_plus", "centres", "diurnal_amp",
               "diurnal_phase", "annual_amp", "annual_phase",
               "cycle_meta", "nl_meta", "ng_meta", "move_meta", "metadata")
